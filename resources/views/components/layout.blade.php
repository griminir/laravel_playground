        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-8" src="https://external-preview.redd.it/nt4qzg38w8-FZQY6HNgxsKS_DZYkk_IIwH3Rdt9Pd_g.jpg?auto=webp&s=0c29ef1ebf2b1bfabd96ed6d52486e0885e4bdbb" alt="Your Company">
                    </div>
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="size-8 rounded-full" src="https://preview.redd.it/ostjb60kfpc61.png?auto=webp&s=1260eb817adc93d999a597d98610fa81e8536545" alt="">
                                </button>
                            </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://preview.redd.it/ostjb60kfpc61.png?auto=webp&s=1260eb817adc93d999a597d98610fa81e8536545" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Jericho Swain</div>
                        <div class="text-sm font-medium text-gray-400">swain@gmail.com</div>
                    </div>
